...
class Announcement extends MY_Controller {
    ...
    //    debug($this->data['announcements']);die;
    ...
    public function announcements_list(){
        ...
        $this->data['announcements'] = $this->announcements_model->getAnnouncementsList($getArr, array($this->input->get('order', false) => $this->input->get('direction', false)), $configPagination['per_page'], $page,0,false,$userLocationsIds);
     
        $this->load->config('pagination', true);

        $configPagination['base_url'] = $this->utility->build_filter_href('/merchant/announcement/announcements_list', array('page' => null));
        $configPagination['total_rows'] = $this->announcements_model->getCountAnnouncements($getArr, array($this->input->get('order', false) => $this->input->get('direction', false)), 0, 0, 0,false,$userLocationsIds);
        ...
        $this->viewData['sidebar'] = $this->load->view('merchant/main/sidebar', $this->data, true);
        $this->viewData['message'] = $this->load->view('merchant/main/message', $this->data, true);
        $this->viewData['content'] = $this->load->view('merchant/announcements/all_announcements_list', $this->data, true);
        $this->viewData['footer'] = $this->load->view('merchant/main/footer', $this->data, true);
        $this->load->view('merchant/main/content', $this->viewData);
    }
    public function my_announcements_list(){
        $this->data = array();
        ...
        $this->data['announcements'] = $this->announcements_model->getAnnouncementsList($getArr, array($this->input->get('order', false) => $this->input->get('direction', false)), $configPagination['per_page'], $page,0,$this->session->userdata('user_id'));
     
        $this->load->config('pagination', true);

        $configPagination['base_url'] = $this->utility->build_filter_href('/merchant/announcement/my_announcements_list', array('page' => null));
        $configPagination['total_rows'] = $this->announcements_model->getCountAnnouncements($getArr, array($this->input->get('order', false) => $this->input->get('direction', false)), 0, 0, 0,$this->session->userdata('user_id'));
        ...
        $this->viewData['sidebar'] = $this->load->view('merchant/main/sidebar', $this->data, true);
        $this->viewData['message'] = $this->load->view('merchant/main/message', $this->data, true);
        $this->viewData['content'] = $this->load->view('merchant/announcements/announcements_list', $this->data, true);
        $this->viewData['footer'] = $this->load->view('merchant/main/footer', $this->data, true);
        $this->load->view('merchant/main/content', $this->viewData);
    }
    ...
    public function add_announcement() {
        ...
        $this->data['companiesArr'] = $this->companies_model->getCompaniesListByLocationId($loc_ids);
        $this->data['usersArr'] = $this->users_model->getUserList($this->session->userdata('company_id'));
        ...
        if($this->input->post('save')){
            if($this->form_validation->run() == true){
                ...
                if($this->_saveData()){
                    ...
                    redirect('/merchant/announcement/announcements_list');
                }
            }
            else {
                //validation errors
        ...
        $this->viewData['sidebar'] = $this->load->view('merchant/main/sidebar', $this->data, true);
        $this->viewData['message'] = $this->load->view('merchant/main/message', $this->data, true);
        $this->viewData['content'] = $this->load->view('merchant/announcements/add_announcement', $this->data, true);
        $this->viewData['footer'] = $this->load->view('merchant/main/footer', $this->data, true);
        $this->load->view('merchant/main/content', $this->viewData);
    }
    ...
    public function edit_announcement($id) {
        ...
        $this->data['companiesArr'] = $this->companies_model->getCompaniesListByLocationId($loc_ids);        
        $this->data['usersArr'] = $this->announcements_model->getAnnouncementsUsers($id,$this->session->userdata('company_id'));
