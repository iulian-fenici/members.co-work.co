...
//    
    ...
    public function get_companies_by_location_id_ajax($locationId = null) {
        ...
        $data = array(
            'success' => 1,
            'html' => $this->load->view('merchant/booking/companies_list', array('companiesList' => $this->data['companiesList']), true)
        );
    ...
    public function get_users_by_company_id_ajax($companyId = null) {
        ...
        $data = array(
            'success' => 1,
            'html' => $this->load->view('merchant/booking/users_list', array('usersList' => $this->data['usersList']), true)
        );
    ...
    public function get_for_users_by_company_id_ajax($companyId = null, $userId = null) {
        ...
        $data = array(
            'success' => 1,
            'html' => $this->load->view('merchant/booking/for_users_list', array('forUsersList' => $this->data['forUsersList']), true)
        );
    ...
    public function get_rooms_by_location_id_ajax($locationId = null) {
        ...
        $data = array(
            'success' => 1,
            'html' => $this->load->view('merchant/booking/rooms_list', array('roomsList' => $this->data['roomsList']), true)
        );
