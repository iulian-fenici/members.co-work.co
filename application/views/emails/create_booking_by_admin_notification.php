...
<td>
        ...
        <tr>
            <td>
                 ...
                 We booked the <?php echo $room_name;?> located at <?php echo $location_name;?> from <?php echo date('g:i a',strtotime($from)).' - '.date('g:i a',strtotime($to));?> on <?php echo date('l, d/m/Y',strtotime($from));?> for you.
