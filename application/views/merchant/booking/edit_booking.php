        ...
        <div class="edit-booking-container">
            <div class="row-fluid">
               <div class="control-group time-cont">
                ...
                <div class="row-fluid">
                    <span class="btn btn-success pull-left" onclick="editBooking('<?php echo '/merchant/booking/add_booking_popup/' . $bookingData->id; ?>')">Edit</span>
                    <?php if (checkBookingAvailableForCancel($bookingData->to)):?>
                        <span class="btn btn-danger pull-right" onclick="deleteBooking('<?php echo '/merchant/booking/cancel_booking/' . $bookingData->id; ?>');">Delete</span>
                    <?php endif;?>
                </div>
            </div>
        </div>
