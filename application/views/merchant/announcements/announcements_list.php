    ...
    <div class="row-fluid" style="margin-bottom: 20px;">
        <div class="span12">    
            ...
            <div style="float: right">
                <?php $this->utility->draw_search_form('announcements_list', '/merchant/announcement/my_announcements_list?'); ?>
            </div>  
        </div>
    </div>
    <div class="row-fluid" >
                    ...
                    <thead>
                        <tr>
                            ...
                            echo $this->utility->draw_table_header(
                                    '/merchant/announcement/my_announcements_list', array(
                        ...
                        <?php if (isset($announcements) && !empty($announcements)): ?>
                            <?php foreach ($announcements as $announcement): ?>                        
                                <tr class="announcement_row">
                                    ...
                                    <td>
                                        <a href="<?php echo '/merchant/announcement/edit_announcement/' . $announcement['id']; ?>"><i class="icon-pencil"></i></a>
                                        <?php if (isset($announcement['active']) && !empty($announcement['active'])): ?>
                                            <a href="<?php echo '/merchant/announcement/change_announcement_activity/' . $announcement['id'] . '/' . 0; ?>"><i class="icon-ban-circle"></i></a>
                                        <?php else: ?>
                                            <a href="<?php echo '/merchant/announcement/change_announcement_activity/' . $announcement['id'] . '/' . 1; ?>"><i class="icon-chevron-down"></i></a>
                                        <?php endif; ?>
                                        <a href="<?php echo '/merchant/announcement/delete_announcement/' . $announcement['id']; ?>" onclick="return confirm('Are you sure you want delete this announcement ?')"><i class="icon-trash"></i></a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        <?php else: ?>
