...
<div class="row">
    <div class="span12 widget clearfix">  
        ...
        <div class="widget-content">
            <form method="post" action="/admin/announcement/<?php echo isset($id) && !empty($id) ? 'edit_announcement/' . $id : 'add_announcement'; ?>" class="form-horizontal">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" class="span5" id="title" name="title" placeholder="Subject" value="<?php echo set_value('title', isset($announcementData['title']) && !empty($announcementData['title']) ? $announcementData['title'] : ''); ?>">
