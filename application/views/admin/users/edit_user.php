...
<div class="row-fluid">
    <div class="span12 widget clearfix">
        ...
        <div class="widget-content">
            <form method="post" action="/admin/user/edit_user/<?php echo $id; ?>" class="form-horizontal">
                    ...
                    <div class="controls">
                        ...
                        <div class="preview">
                            <?php if (isset($userData['thumb_name']) && !empty($userData['thumb_name']) && file_exists($userData['thumb_rel_path'] . $userData['thumb_name'])): ?>
                             ...
                             <?php else:?>
                                <div class="image-item">
                                    <img src="/img/main/no_profile_photo.png" class="img-polaroid" />
                                </div>
                            <?php endif; ?>   
                        </div>
                    </div>
    ...
    $(function () {
        ...
        $('.delete-file').live('click',function(){
            ...
            if(confirm('Are you sure you want delete this file')){
                $.ajax({
                    url: "/admin/user/delete_user_photo",
                    type: "POST",
                    data:{
                        userId: userId
                    },
