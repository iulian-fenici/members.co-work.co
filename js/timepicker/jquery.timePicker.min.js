...
(function($){
  ...
  function formatTime(time, settings) {
    ...
    return formatNumber(hours,true) + settings.separator + formatNumber(minutes) + (settings.show24Hours ? '' : ((h < 12) ? ' AM' : ' PM'));
  }

  function formatNumber(value,withoutNull) {
    if(typeof(withoutNull)==='undefined') withoutNull = false;
    if(withoutNull){
        return value;
    }  else{
